...
<body class="inner">
    ...
    <div id="sectionstudio">
        <img src="studio.png" class="img3" />
        <div class="card3">
            <h1 class="head">Rs 14000/-</h1>
            <div class="d-flex flex-row">
                <img src="https://assets.ccbp.in/frontend/static-website/flats-list-location-icon-img.png" class="img4" />
                <p class="p">D/N 7-3,Royal street,RK valley</p>
            </div>
            <hr class="hh" />
            <h1 class="head">Description</h1>
            <p class="p">A room with a studio bed- a couch which can be converted into a bed. May also have an additional bed.

The room size or area of Studio room types are generally between 25 m² to 40 m².</p>
            <div class=" d-flex flex-row">
                            ...
                            <div class="modal-body model-body-style">
                                <form id="myForm" action="hoteldetails.php" method="POST" onsubmit="return validateForm()">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control" type="text" id="info" name="info" value="studio" readonly>
