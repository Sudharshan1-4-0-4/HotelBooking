...
<body class="inner">
    ...
    <div id="sectionsta">
        <img src="standard.png" class="img3" />
        <div class="card3">
            <h1 class="head">Rs 13000/-</h1>
            <div class="d-flex flex-row">
                <img src="https://assets.ccbp.in/frontend/static-website/flats-list-location-icon-img.png" class="img4" />
                <p class="p">D/N 7-2,Royal street,RK valley</p>
            </div>
            <hr class="hh" />
            <h1 class="head">Description</h1>
            <p class="p">Standard room means accommodation with basic amenities such as proper lighting, toilet with running water, ventilation and door locking system.</p>
            <div class=" d-flex flex-row">
                            ...
                            <div class="modal-body model-body-style">
                                <form id="myForm" action="hoteldetails.php" method="POST" onsubmit="return validateForm()">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control" type="text" id="info" name="info" value="standard" readonly>
