    ...
    <div id="sectiontwin">
        ...
        <div class="card3">
            ...
            <div class="d-flex flex-row">
                ...
                <p class="p">D/N 7-4,Royal street,RK valley</p>
            </div>
            <hr class="hh" />
            <h1 class="head">Description</h1>
            <p class="p">A room with two twin beds. May be occupied by one or more people.
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body model-body-style">
                                <form id="myForm" action="hoteldetails.php" method="POST" onsubmit="return validateForm()" enctype="multipart/form-data">
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control" type="text" id="info" name="info" value="twin" readonly>
