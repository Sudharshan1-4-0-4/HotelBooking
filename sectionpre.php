...
<body class="inner">
    ...
    <div id="sectionpre">
        <img src="pre.png" class="img3" />
        <div class="card3">
            <h1 class="head">Rs 11000/-</h1>
            <div class="d-flex flex-row">
                <img src="https://assets.ccbp.in/frontend/static-website/flats-list-location-icon-img.png" class="img4" />
                <p class="p">D/N 6-8,Royal street,RK valley</p>
            </div>
            <hr class="hh" />
            <h1 class="head">Description</h1>
            <p class="p">he most expensive room provided by a hotel. Usually, only one president suite is available in one single hotel property.The room size or area of Presidential Suites are generally between 80 m² to 350 m².</p>
            <div class=" d-flex flex-row">
                            ...
                            <div class="modal-body model-body-style">
                                <form id="myForm" action="hoteldetails.php" method="POST" onsubmit="return validateForm()">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control" type="text" id="info" name="info" value="presidential" readonly>
