    ...
    <div id="sectionsingle">
        ...
        <div class="card3">
            ...
            <div class="d-flex flex-row">
                ...
                <p class="p">D/N 7-1,Royal street,RK valley</p>
            </div>
            <hr class="hh" />
            <h1 class="head">Description</h1>
            <p class="p">A room assigned to one person. May have one or more beds.
                            ...
                            <div class="modal-body model-body-style">
                                <form id="myForm" action="hoteldetails.php" method="POST" onsubmit="return validateForm()">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control" type="text" id="info" name="info" value="single" readonly>
