...
<body class="inner">
    ...
    <div id="sectionking">
        <img src="kin.png" class="img3" />
        <div class="card3">
            <h1 class="head">Rs 10000/-</h1>
            <div class="d-flex flex-row">
                <img src="https://assets.ccbp.in/frontend/static-website/flats-list-location-icon-img.png" class="img4" />
                <p class="p">D/N 6-7,Royal street,RK valley</p>
            </div>
            <hr class="hh" />
            <h1 class="head">Description</h1>
            <p class="p">A room with a king-sized bed. May be occupied by one or more people.

The room size or area of King Rooms are generally between 32 m² to 50 m².</p>
            <div class=" d-flex flex-row">
                            ...
                            <div class="modal-body model-body-style">
                                <form id="myForm" action="hoteldetails.php" method="POST" onsubmit="return validateForm()">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control" type="text" id="info" name="info" value="king" readonly>
